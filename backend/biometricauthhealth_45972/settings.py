"""
Django settings for biometricauthhealth_45972 project.
...
ROOT_URLCONF = 'biometricauthhealth_45972.urls'
...
WSGI_APPLICATION = 'biometricauthhealth_45972.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "biometricauthhealth_45972 API",
    "DESCRIPTION": "API documentation for biometricauthhealth_45972 App",
    "VERSION": "v1",
}
